import 'package:serpa_maps/proto/src/themes/v3/_package.dart' as v3;
import 'package:serpa_maps/proto/src/themes/v4/_package.dart' as v4;
...
class ProtomapsThemes {
  ...
  static Theme grayscaleV4({Logger? logger}) => ProtomapsThemes(
    logger: logger,
    sprites: 'https://protomaps.github.io/basemaps-assets/sprites/v4/grayscale',
